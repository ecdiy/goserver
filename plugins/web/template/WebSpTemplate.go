...
func   Template(ele *utils.Element, data map[string]interface{}) {
...
func   getTemplateRender(data map[string]interface{}, SpSuffix, loginUrl, TplName string) func(ctx *gin.Context) {
...
func   GetTplName(ctx *gin.Context) string {
